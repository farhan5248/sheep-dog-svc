...
public class AsciiDocSyntacticSequencer extends AbstractSyntacticSequencer {

	protected AsciiDocGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (AsciiDocGrammarAccess) access;
	}
