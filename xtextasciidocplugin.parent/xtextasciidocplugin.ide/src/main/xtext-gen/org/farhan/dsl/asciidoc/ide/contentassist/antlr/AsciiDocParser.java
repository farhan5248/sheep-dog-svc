...
public class AsciiDocParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AsciiDocGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGivenAccess().getAlternatives_5(), "rule__Given__Alternatives_5");
			...
			builder.put(grammarAccess.getGivenAccess().getTableAssignment_5_0(), "rule__Given__TableAssignment_5_0");
			builder.put(grammarAccess.getGivenAccess().getTextAssignment_5_1(), "rule__Given__TextAssignment_5_1");
			...
			builder.put(grammarAccess.getWhenAccess().getTableAssignment_5_0(), "rule__When__TableAssignment_5_0");
			builder.put(grammarAccess.getWhenAccess().getTextAssignment_5_1(), "rule__When__TextAssignment_5_1");
			...
			builder.put(grammarAccess.getThenAccess().getTableAssignment_5_0(), "rule__Then__TableAssignment_5_0");
			builder.put(grammarAccess.getThenAccess().getTextAssignment_5_1(), "rule__Then__TextAssignment_5_1");
			...
			builder.put(grammarAccess.getAndAccess().getTableAssignment_5_0(), "rule__And__TableAssignment_5_0");
			builder.put(grammarAccess.getAndAccess().getTextAssignment_5_1(), "rule__And__TextAssignment_5_1");
